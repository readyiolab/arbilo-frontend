...
const faqs = [
  {
    ...
    answer:
      "Arbilo , ArbiPair is a unique algorithm for pair-based crypto arbitrage. Maximize profits across exchanges without fiat transfers. Trade smarter, not harder! ",
  },
  {
  ...
  },
  {
    question: "Is there a free trial available?",
    answer:
      "Yes! We offer a 7-day free trial with both our monthly and 6-month plans. You can explore all features risk-free and experience Arbilo’s real-time arbitrage and sentiment signals.Even a single successful trade can cover your full subscription — making it a high-value tool for active traders.",
  },
];
